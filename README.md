...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/stabilityai
```

A live public deployment of this template is available at [https://stabilityai.templates.workers.dev](https://stabilityai.templates.workers.dev)
